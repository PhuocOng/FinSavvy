...
const ResetPassword = () => {
  ...
  return (
    <div className='flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 to-blue-100'>
      ...
      <form onSubmit={onSubmitEmail} className='bg-[#d0ebff] p-8 rounded-lg shadow-lg w-96 text-sm'>
        ...
        <button className='w-full py-3 bg-gradient-to-r from-[#60a5fa] to-[#3b82f6] rounded-full'>Submit</button>
      </form>
      ...
      <form onSubmit={OnSubmitOtp} className='bg-[#d0ebff] p-8 rounded-lg shadow-lg w-96 text-sm'>
        ...
        <button className='w-full py-2.5 bg-gradient-to-r from-[#60a5fa] to-[#3b82f6] rounded-full'>Submit</button>
      </form>
      }
      ...
      {/* Enter new password */}
      {isOtpSubmitted && isEmailSent &&
      <form onSubmit={onSubmitPassword} className='bg-[#d0ebff] p-8 rounded-lg shadow-lg w-96 text-sm'>
